// frontend - src - components - Layout - AdminLayout
...
const navGroups = [
  ...
  },
  {
    label: 'Operaciones',
    items: [
      { to: '/admin/merchandising', icon: 'ti-shirt',            label: 'Merchandising' },
      { to: '/admin/reportes',      icon: 'ti-chart-bar',        label: 'Reportes' },
      { to: '/admin/staff',         icon: 'ti-id-badge-2',       label: 'Staff' },
      { to: '/admin/configuracion', icon: 'ti-settings',         label: 'Configuración' },
      { to: '/admin/auditoria',     icon: 'ti-shield-check',     label: 'Auditoría' },
    ],
  },
]
        ...
        <aside style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              background: '#e8b84b', flexShrink: 0, display: 'inline-block',
            }} />
            <span style={{
          ...
          <div style={{
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ fontSize: '12px', fontWeight: 500, color: '#fff', margin: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {user?.email}
              </p>
            ...
            >
              <i className="ti ti-logout" style={{ fontSize: '16px' }} aria-label="Cerrar sesión" />
            </button>
          </div>
        </aside>
